...
Input values are stored and evaluated in application state

Arithmetic operations are handled through conditional logic
...
Synchronizing UI with application logic
